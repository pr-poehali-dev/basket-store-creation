        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: '0.15s' }}>
            ...
            <div className="absolute -bottom-6 -left-6 bg-card border border-border px-6 py-4 shadow-sm">
              <p className="font-display text-3xl font-semibold text-accent">12 лет</p>
      ...
      <section id="delivery" className="py-24 px-6 bg-secondary/40">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: 'Truck', t: 'По всей России', d: 'Транспортными компаниями до терминала или адреса. Срок 2–7 дней.' },
              { icon: 'Package', t: 'Своя упаковка', d: 'Надёжная упаковка партий, защита от деформации при перевозке.' },
              { icon: 'MapPin', t: 'Самовывоз', d: 'Со склада производства. Возможна отгрузка день в день.' },
            ].map((d) => (
