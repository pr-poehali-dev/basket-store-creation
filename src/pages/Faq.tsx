    ...
    answer: (
      <div className="space-y-4 text-sm text-muted-foreground">
        <div>
          ...
          <p>Заказы до 20 000₽ отправляем ТК КИТ, ПЭК, СДЭК, Деловые линии, Мэджик Транс. Самые выгодные тарифы для нашего типа товара у ТК КИТ.</p>
        ...
        <div>
          ...
          <p>Заказы от 20 000₽ выгоднее отправлять сборным грузом до адреса через официальный сервис ATI.SU.</p>
